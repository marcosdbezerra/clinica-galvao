      ...
      <div className="grid lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl p-6 space-y-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-secondary">{contactInfo.city}</p>
        ...
        >
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-[#25D366]/10 to-[#25D366]/5 rounded-2xl p-8 text-center"
          >
            ...
            <p className="text-secondary mb-6">
              Atendimento rápido e prático. Clique abaixo e fale diretamente com
              nossa equipe.
            </p>
            <button
